 ...
 * 
 * SUPERIDEA-->
 *          1º una var a la q se le mete q archivo tiene el error
 *          2º crear un array a parte q contenga q archivos subir, para q no t suba dos y tres no xq el tercero de fallo
 *                  $array[0][origen, destino, indice del this->files[]];
 *                  cuando termine de verificar todo llamar a un metodo subir3
 *                             move_upload_file(array[1][origen], array[2][destino]);
 * 
 */